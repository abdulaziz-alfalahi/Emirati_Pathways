...
(
    ...
    'برنامج شامل في العلوم والتكنولوجيا يركز على الروبوتات والذكاء الاصطناعي والحلول التكنولوجية المستدامة',
    'STEM', 'Robotics & AI',
...
(
    ...
    'تطوير المواهب الفنية من خلال التعليم الشامل للفنون البصرية والأدائية',
    'Arts', 'Visual Arts',
...
(
    ...
    'برنامج شامل للفنون الأدائية يغطي الدراما والموسيقى والرقص',
...
(
    ...
    'دمج التميز الرياضي مع تطوير القيادة والإنجاز الأكاديمي',
    'Sports', 'Leadership',
...
(
    ...
    'برنامج لغوي متقدم يركز على العربية والإنجليزية والفرنسية والماندرين',
...
(
    ...
    'تطوير مهارات ريادة الأعمال من خلال مشاريع تجارية حقيقية',
...
-- Insert sample workflow history for some programs (only if tables exist)
DO $$
DECLARE
    sample_user_id UUID;
...
BEGIN
    ...
    IF sample_user_id IS NOT NULL AND stem_program_id IS NOT NULL AND 
