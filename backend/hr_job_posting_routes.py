...
def get_job_postings():
    ...
    try:
        ...
        try:
            ...
            # Fixed SQL query to match actual job_postings table schema:
            # jd_id, title, company_id, location, status, application_count, created_at,
            # description, requirements, responsibilities, benefits, salary_range_min,
            # salary_range_max, employment_type, experience_level, recruiter_id, updated_at
            cursor.execute(f"""
                SELECT 
                    jp.jd_id,
                    jp.jd_id as id,
                    ...
                    jp.created_at,
                    jp.updated_at,
                    COALESCE(jp.application_count, 0) as applications_count,
