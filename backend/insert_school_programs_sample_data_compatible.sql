-- School Programs Sample Data for PostgreSQL (Compatible Version)
-- Compatible with existing database structure using correct primary key names
-- Created: 2025-09-27
...
-- STEM Programs
(
    (SELECT school_id FROM schools WHERE code = 'DIA001'),
...
(
    (SELECT school_id FROM schools WHERE code = 'GWA002'),
...
(
    (SELECT school_id FROM schools WHERE code = 'ASD003'),
...
BEGIN
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'program_success_metrics') THEN
        ...
        (
            (SELECT program_id FROM school_programs WHERE title_en = 'Advanced STEM Innovation Program'),
            95.5, 88.2, 4.8, 12,
            ARRAY['Dubai Innovation Award 2023', 'KHDA Excellence in STEM 2024'],
            4.7, 92.3, 96.8, 15
        ),
        (
            (SELECT program_id FROM school_programs WHERE title_en = 'Sustainable Engineering Challenge'),
            91.2, 85.7, 4.6, 8,
            ARRAY['Green Schools Award 2023', 'Sustainability Excellence 2024'],
            4.5, 89.1, 94.2, 10
        ),
        (
            (SELECT program_id FROM school_programs WHERE title_en = 'Creative Arts Excellence Program'),
            93.8, 78.5, 4.7, 15,
            ARRAY['Arts Education Excellence 2023', 'Creative Innovation Award 2024'],
            4.6, 91.5, 89.3, 12
        ),
        (
            (SELECT program_id FROM school_programs WHERE title_en = 'Performing Arts Academy'),
            96.2, 82.1, 4.9, 18,
            ARRAY['Performing Arts Excellence 2023', 'Cultural Achievement Award 2024'],
            4.8, 94.7, 87.6, 20
        ),
        (
            (SELECT program_id FROM school_programs WHERE title_en = 'Sports Leadership Academy'),
            94.1, 91.3, 4.7, 10,
...
BEGIN
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'program_tags') THEN
        ...
        -- STEM Program tags
        ((SELECT program_id FROM school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Robotics', 'technology'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Artificial Intelligence', 'technology'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Innovation', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Problem Solving', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Programming', 'technology'),

        -- Engineering Program tags
        ((SELECT program_id FROM school_programs WHERE title_en = 'Sustainable Engineering Challenge'), 'Sustainability', 'methodology'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Sustainable Engineering Challenge'), 'Environmental Science', 'technology'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Sustainable Engineering Challenge'), 'Design Thinking', 'methodology'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Sustainable Engineering Challenge'), 'Green Technology', 'technology'),

        -- Arts Program tags
        ((SELECT program_id FROM school_programs WHERE title_en = 'Creative Arts Excellence Program'), 'Digital Art', 'technology'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Creative Arts Excellence Program'), 'Traditional Art', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Creative Arts Excellence Program'), 'Portfolio Development', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Creative Arts Excellence Program'), 'Creative Expression', 'skill'),

        -- Performing Arts tags
        ((SELECT program_id FROM school_programs WHERE title_en = 'Performing Arts Academy'), 'Drama', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Performing Arts Academy'), 'Music', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Performing Arts Academy'), 'Dance', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Performing Arts Academy'), 'Stage Performance', 'skill'),

        -- Sports Program tags
        ((SELECT program_id FROM school_programs WHERE title_en = 'Sports Leadership Academy'), 'Leadership', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Sports Leadership Academy'), 'Team Sports', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Sports Leadership Academy'), 'Athletic Performance', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Sports Leadership Academy'), 'Sports Management', 'skill'),

        -- Language Program tags
        ((SELECT program_id FROM school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'Arabic', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'English', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'French', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'Mandarin', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'Cultural Awareness', 'skill'),

        -- Business Program tags
        ((SELECT program_id FROM school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Entrepreneurship', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Business Planning', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Financial Literacy', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Innovation', 'skill'),
        ((SELECT program_id FROM school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Leadership', 'skill');
    END IF;
END $$;
...
BEGIN
    ...
    IF user_count > 0 THEN
        ...
        IF sample_user_id IS NOT NULL THEN
            SELECT program_id INTO stem_program_id FROM school_programs WHERE title_en = 'Advanced STEM Innovation Program';
