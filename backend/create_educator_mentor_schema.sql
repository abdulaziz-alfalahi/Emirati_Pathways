-- =====================================================
-- EDUCATOR AND MENTOR PERSONA DATABASE SCHEMA
...
-- Curriculum Standards (UAE MOE Standards)
...
-- =====================================================
-- INDEXES FOR EDUCATOR TABLES
-- =====================================================

-- Educator Profiles Indexes
CREATE INDEX IF NOT EXISTS idx_educator_profiles_user_id ON educator_profiles(user_id);
CREATE INDEX IF NOT EXISTS idx_educator_profiles_institution_id ON educator_profiles(institution_id);
CREATE INDEX IF NOT EXISTS idx_educator_profiles_active ON educator_profiles(is_active);
CREATE INDEX IF NOT EXISTS idx_educator_profiles_verified ON educator_profiles(is_verified);

-- Educational Institutions Indexes
CREATE INDEX IF NOT EXISTS idx_educational_institutions_type ON educational_institutions(institution_type);
CREATE INDEX IF NOT EXISTS idx_educational_institutions_emirate ON educational_institutions(emirate);
...
CREATE INDEX IF NOT EXISTS idx_course_enrollments_student_id ON course_enrollments(student_user_id);
...
CREATE INDEX IF NOT EXISTS idx_mentorship_sessions_mentee_id ON mentorship_sessions(mentee_user_id);
CREATE INDEX IF NOT EXISTS idx_mentorship_sessions_date ON mentorship_sessions(scheduled_date);
CREATE INDEX IF NOT EXISTS idx_mentorship_sessions_status ON mentorship_sessions(session_status);

-- Mentorship Matching Indexes
CREATE INDEX IF NOT EXISTS idx_mentorship_matching_mentee_id ON mentorship_matching(mentee_user_id);
CREATE INDEX IF NOT EXISTS idx_mentorship_matching_mentor_id ON mentorship_matching(mentor_id);
CREATE INDEX IF NOT EXISTS idx_mentorship_matching_status ON mentorship_matching(match_status);
CREATE INDEX IF NOT EXISTS idx_mentorship_matching_active ON mentorship_matching(is_active);
...
-- Educator Tables Triggers
CREATE TRIGGER update_educator_profiles_updated_at BEFORE UPDATE ON educator_profiles FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE TRIGGER update_mentorship_programs_updated_at BEFORE UPDATE ON mentorship_programs FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE TRIGGER update_mentorship_goals_updated_at BEFORE UPDATE ON mentorship_goals FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_mentorship_matching_updated_at BEFORE UPDATE ON mentorship_matching FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_career_development_plans_updated_at BEFORE UPDATE ON career_development_plans FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_mentorship_schedules_updated_at BEFORE UPDATE ON mentorship_schedules FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_mentor_specializations_updated_at BEFORE UPDATE ON mentor_specializations FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
INSERT INTO curriculum_standards (standard_code, standard_name, subject_area, grade_level, description, moe_reference) VALUES
('UAE-MATH-G10-001', 'Advanced Mathematics Grade 10', 'Mathematics', 'Grade 10', 'Advanced mathematical concepts for Grade 10 students', 'MOE-CURR-2024-MATH'),
('UAE-SCI-G12-001', 'Physics Grade 12', 'Science', 'Grade 12', 'Comprehensive physics curriculum for Grade 12', 'MOE-CURR-2024-SCI'),
('UAE-ENG-G9-001', 'English Language Arts Grade 9', 'English', 'Grade 9', 'English language and literature for Grade 9', 'MOE-CURR-2024-ENG')
