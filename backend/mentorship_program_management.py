...
class MentorshipProgramManager:
    ...
    def _generate_program_recommendations(self, program: MentorshipProgram) -> str:
        ...
        try:
            ...
            return response.text if response.text else "AI recommendations could not be generated"
    ...
    def _generate_ai_insights(self, program: MentorshipProgram) -> str:
        ...
        try:
            ...
            response = model.generate_content(prompt)
            return response.text if response.text else "AI insights could not be generated"
