...
def get_roles():
    ...
    try:
        roles = [
            ...
            {'id': 'career_services_operator', 'name': 'career_services_operator', 'display_name': 'Career Services Operator', 'description': 'Manage salary benchmarks, startups, internships & gigs', 'permissions': ['view_analytics'], 'is_system': True, 'category': 'Growth Operators'},
