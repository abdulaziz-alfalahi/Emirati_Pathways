...
def get_roles():
    ...
    try:
        roles = [
            ...
            {'id': 'career_services_operator', 'name': 'career_services_operator', 'display_name': 'Career Services Operator', 'description': 'Manage the candidate counselling pipeline: caseloads, call outcomes, counselling notes and preferences', 'permissions': ['view_dashboard', 'manage_candidate_counselling', 'view_analytics'], 'is_system': True, 'category': 'Growth Operators'},
            {'id': 'professional_dev_operator', 'name': 'professional_dev_operator', 'display_name': 'Professional Development Operator', 'description': 'Manage training programs and certifications', 'permissions': ['manage_training', 'manage_certifications', 'view_analytics'], 'is_system': True, 'category': 'Growth Operators'},
            # End User Roles
