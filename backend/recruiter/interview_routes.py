...
# Create blueprint
interview_routes = Blueprint('recruiter_interviews', __name__)
...
@interview_routes.route('/health', methods=['GET'])
def health_check():
...
@interview_routes.route('/api/recruiter/interviews/create', methods=['POST'])
...
@interview_routes.route('/api/recruiter/interviews/jd/<jd_id>', methods=['GET'])
...
@interview_routes.route('/api/recruiter/interviews/<interview_id>', methods=['GET'])
...
@interview_routes.route('/api/recruiter/interviews/<interview_id>', methods=['PUT'])
...
@interview_routes.route('/api/recruiter/interviews/<interview_id>/cancel', methods=['POST'])
...
@interview_routes.route('/api/recruiter/interviews/<interview_id>/reschedule', methods=['POST'])
...
@interview_routes.route('/api/recruiter/interviews/<interview_id>/complete', methods=['POST'])
...
@interview_routes.route('/api/recruiter/interviews/<interview_id>/confirm', methods=['POST'])
...
@interview_routes.route('/api/recruiter/interviews/<interview_id>/remind', methods=['POST'])
...
@interview_routes.route('/api/recruiter/interviews/stats/<jd_id>', methods=['GET'])
...
@interview_routes.route('/api/recruiter/interviews/shortlist/<shortlist_id>', methods=['GET'])
