...
CREATE TABLE IF NOT EXISTS companies (
    ...
    company_type VARCHAR(100), -- 'government', 'private', 'semi-government', 'startup', 'multinational'
...
INSERT INTO companies (company_name, company_type, industry, company_size, headquarters_location, description, emiratization_percentage) VALUES
('Emirates Tech Solutions', 'private', 'Technology', '51-200', 'Dubai, UAE', 'Leading technology solutions provider in the UAE', 25.00),
('Abu Dhabi Government Services', 'government', 'Government', '1000+', 'Abu Dhabi, UAE', 'Government services and digital transformation', 85.00),
('Gulf Innovation Hub', 'startup', 'Technology', '11-50', 'Dubai, UAE', 'Innovation hub for emerging technologies', 15.00)
