...
${JSON.stringify(selectedFeedback.metadata, null, 2)}
              ...
              <TabsContent value="system" className="space-y-6">
                ...
                {/* Expiries — what can take the service down on a date (shared with the Operations Center) */}
                <ExpiryDatesCard endpoint="/api/admin/system/expiries" isRTL={isRTL} active={activeTab === 'system'} />
              </TabsContent>
