              ...
              {navigationGroups.map((group) => (
                ...
                >
                  ...
                  {activeDropdown === group.id && (
                    <div className="absolute top-full start-0 mt-1 w-80 bg-white rounded-lg shadow-xl border border-slate-200 z-50">
                      <div className="p-4">
                        <div className="mb-3">
              ...
              {navigationGroups.map((group) => (
                <div key={group.id} className="border-b border-slate-100 pb-4 last:border-b-0">
                  <h3 className="font-semibold text-slate-900 mb-3 flex items-center">
                    <span className="w-3 h-3 bg-teal-600 rounded-full me-2"></span>
                    {group.name}
                  </h3>
