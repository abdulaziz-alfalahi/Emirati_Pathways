...
export { default as EducationalInstitutionDashboard } from './EducationalInstitutionDashboard';
...
export { default as GovRepDashboard } from './GovRepDashboard';
export { default as EntrepreneurDashboard } from './EntrepreneurDashboard';
