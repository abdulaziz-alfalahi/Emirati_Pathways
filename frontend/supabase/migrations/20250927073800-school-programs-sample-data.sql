...
-- STEM Programs
(
  (SELECT id FROM public.schools WHERE code = 'DIA001'),
  'Advanced STEM Innovation Program',
  'برنامج الابتكار المتقدم في العلوم والتكنولوجيا',
  ...
  'برنامج شامل في العلوم والتكنولوجيا يركز على الروبوتات والذكاء الاصطناعي والحلول التكنولوجية المستدامة. يشارك الطلاب في مشاريع عملية وبحوث وتحديات الابتكار.',
  'STEM', 'Robotics & AI',
...
(
  (SELECT id FROM public.schools WHERE code = 'GWA002'),
  'Sustainable Engineering Challenge',
  'تحدي الهندسة المستدامة',
  'Students work on real-world engineering challenges focused on sustainability and environmental solutions.',
  'يعمل الطلاب على تحديات هندسية حقيقية تركز على الاستدامة والحلول البيئية.',
  'STEM', 'Engineering',
...
(
  ...
  'برنامج التميز في الفنون الإبداعية',
  ...
  'تطوير المواهب الفنية من خلال التعليم الشامل للفنون البصرية والأدائية، بما في ذلك الفن الرقمي والرسم التقليدي والنحت والمشاريع متعددة الوسائط.',
  'Arts', 'Visual Arts',
...
(
  (SELECT id FROM public.schools WHERE code = 'ASD003'),
  'Performing Arts Academy',
  'أكاديمية الفنون الأدائية',
  'A comprehensive performing arts program covering drama, music, and dance with professional-level training.',
  'برنامج شامل للفنون الأدائية يغطي الدراما والموسيقى والرقص مع تدريب على المستوى المهني.',
...
(
  ...
  'دمج التميز الرياضي مع تطوير القيادة والإنجاز الأكاديمي. التركيز على الرياضات الجماعية والأداء الفردي وإدارة الرياضة.',
  'Sports', 'Leadership',
...
(
  ...
  'التميز في التواصل متعدد اللغات',
  ...
  'برنامج لغوي متقدم يركز على العربية والإنجليزية والفرنسية والماندرين مع الانغماس الثقافي ومهارات التواصل الدولي.',
...
(
  ...
  'برنامج رواد الأعمال الشباب',
  'Develop entrepreneurial skills through real business projects, mentorship, and startup incubation.',
  'تطوير مهارات ريادة الأعمال من خلال مشاريع تجارية حقيقية والإرشاد وحاضنة الشركات الناشئة.',
...
-- Insert success metrics for published programs
INSERT INTO public.program_success_metrics (
...
(
  (SELECT id FROM public.school_programs WHERE title_en = 'Advanced STEM Innovation Program'),
  95.5, 88.2, 4.8, 12,
  ARRAY['Dubai Innovation Award 2023', 'KHDA Excellence in STEM 2024'],
  4.7, 92.3, 96.8, 15
),
(
  (SELECT id FROM public.school_programs WHERE title_en = 'Sustainable Engineering Challenge'),
  91.2, 85.7, 4.6, 8,
  ARRAY['Green Schools Award 2023', 'Sustainability Excellence 2024'],
  4.5, 89.1, 94.2, 10
),
(
  (SELECT id FROM public.school_programs WHERE title_en = 'Creative Arts Excellence Program'),
  93.8, 78.5, 4.7, 15,
  ARRAY['Arts Education Excellence 2023', 'Creative Innovation Award 2024'],
  4.6, 91.5, 89.3, 12
),
(
  (SELECT id FROM public.school_programs WHERE title_en = 'Performing Arts Academy'),
  96.2, 82.1, 4.9, 18,
  ARRAY['Performing Arts Excellence 2023', 'Cultural Achievement Award 2024'],
  4.8, 94.7, 87.6, 20
),
(
  (SELECT id FROM public.school_programs WHERE title_en = 'Sports Leadership Academy'),
  94.1, 91.3, 4.7, 10,
...
-- Insert program tags
INSERT INTO public.program_tags (program_id, tag_name, tag_type) VALUES
-- STEM Program tags
((SELECT id FROM public.school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Robotics', 'technology'),
((SELECT id FROM public.school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Artificial Intelligence', 'technology'),
((SELECT id FROM public.school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Innovation', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Problem Solving', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Advanced STEM Innovation Program'), 'Programming', 'technology'),

-- Engineering Program tags
((SELECT id FROM public.school_programs WHERE title_en = 'Sustainable Engineering Challenge'), 'Sustainability', 'methodology'),
((SELECT id FROM public.school_programs WHERE title_en = 'Sustainable Engineering Challenge'), 'Environmental Science', 'technology'),
((SELECT id FROM public.school_programs WHERE title_en = 'Sustainable Engineering Challenge'), 'Design Thinking', 'methodology'),
((SELECT id FROM public.school_programs WHERE title_en = 'Sustainable Engineering Challenge'), 'Green Technology', 'technology'),

-- Arts Program tags
((SELECT id FROM public.school_programs WHERE title_en = 'Creative Arts Excellence Program'), 'Digital Art', 'technology'),
((SELECT id FROM public.school_programs WHERE title_en = 'Creative Arts Excellence Program'), 'Traditional Art', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Creative Arts Excellence Program'), 'Portfolio Development', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Creative Arts Excellence Program'), 'Creative Expression', 'skill'),

-- Performing Arts tags
((SELECT id FROM public.school_programs WHERE title_en = 'Performing Arts Academy'), 'Drama', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Performing Arts Academy'), 'Music', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Performing Arts Academy'), 'Dance', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Performing Arts Academy'), 'Stage Performance', 'skill'),

-- Sports Program tags
((SELECT id FROM public.school_programs WHERE title_en = 'Sports Leadership Academy'), 'Leadership', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Sports Leadership Academy'), 'Team Sports', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Sports Leadership Academy'), 'Athletic Performance', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Sports Leadership Academy'), 'Sports Management', 'skill'),

-- Language Program tags
((SELECT id FROM public.school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'Arabic', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'English', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'French', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'Mandarin', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Multilingual Communication Excellence'), 'Cultural Awareness', 'skill'),

-- Business Program tags
((SELECT id FROM public.school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Entrepreneurship', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Business Planning', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Financial Literacy', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Innovation', 'skill'),
((SELECT id FROM public.school_programs WHERE title_en = 'Young Entrepreneurs Program'), 'Leadership', 'skill');

-- Insert sample workflow history for some programs
INSERT INTO public.program_workflow_history (
...
(
  ...
  (SELECT id FROM auth.users LIMIT 1), 'content_creator',
...
(
  ...
  (SELECT id FROM auth.users LIMIT 1), 'technical_reviewer',
...
(
  ...
  (SELECT id FROM auth.users LIMIT 1), 'educational_reviewer',
...
(
  ...
  (SELECT id FROM auth.users LIMIT 1), 'policy_reviewer',
...
(
  ...
  (SELECT id FROM auth.users LIMIT 1), 'khda_director',
...
CREATE TRIGGER update_program_success_metrics_updated_at
  BEFORE UPDATE ON public.program_success_metrics
  FOR EACH ROW
  EXECUTE FUNCTION update_program_updated_at();
