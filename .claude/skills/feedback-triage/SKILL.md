...
4. **Screenshot path** — the file lives **on APPQA** (10.228.145.5), not this box. Fetch via ssh/scp (password prompt — may need the user to run it) and read it; the screenshot often contradicts the verbal description.
